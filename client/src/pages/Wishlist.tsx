...
import { ArrowLeft, Check, Heart, Scale, Trash2, X } from "lucide-react";
...
export default function Wishlist() {
  ...
  const properties = useMemo(() => {
    const filtered = savedProperties.filter(property => priceFilter === "all" || priceFilter === "above" ? priceFilter === "all" || property.price > 30000000 : property.price <= Number(priceFilter));
