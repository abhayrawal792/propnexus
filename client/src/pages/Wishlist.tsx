...
export default function Wishlist() {
  ...
  const recentProperties = recentlyViewedIds.map(id => allProperties.find(property => property.id === id)).filter((property): property is Property => Boolean(property)).filter(property => !visibleFavoriteIds.includes(property.id));
